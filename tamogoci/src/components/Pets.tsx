...
const pets = [
  {
    ...
    stats: { health: 80, happiness: 90, energy: 60 },
  },
  {
    id: 2,
    name: "Spike",
    ...
    stats: { health: 95, happiness: 85, energy: 100 },
  },
  {
    id: 3,
    name: "Nibbles",
    ...
    stats: { health: 70, happiness: 75, energy: 50 },
  },
  {
    id: 4,
    name: "Blaze",
    ...
    stats: { health: 100, happiness: 65, energy: 85 },
  },
];
    ...
    <main className="pets-container">
      <div className="pets-main">
        ...
        <div className="confirm-btn">
          ...
          <button className="choose-btn" onClick={() => idHanlder(pets[count].id)}>CHOOSE</button>
        </div>
